...
echo ""
echo "To trigger your first release: bump VERSION_NAME and VERSION_CODE in"
echo "gradle.properties through a PR; when it lands on main, release-apk.yml"
echo "fires and Battleship.apk appears at:"
